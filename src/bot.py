...
class RAGBot:
    ...
    def _setup_handlers(self):
        ...
        def send_welcome(message):
            welcome_text = """👋 Здравствуйте! Я бот-ассистент по книге "Горц А. - Нематериальное".
            ...
            ❗️ Важно: Я отвечаю только на основе содержания книги и не использую внешние источники информации."""
